...
void GPIO_init(void)
{
	...
	pinModeAF(TIMER_BLDC_EMERGENCY_SHUTDOWN,AF_TIMER0_BRKIN,GPIO_PUPD_NONE)
...
void USART1_Init(uint32_t iBaud)
{
	...
	// Init USART1
	pinModeAF(USART1_TX, AF_USART1_TX, GPIO_PUPD_PULLUP);	// // GD32F130: GPIO_AF_1 = USART
	pinModeAF(USART1_RX, AF_USART1_RX, GPIO_PUPD_PULLUP);	
...
void USART0_Init(uint32_t iBaud)
{
	...
	// Init USART0
	pinModeAF(USART0_TX, AF_USART0_TX, GPIO_PUPD_PULLUP);	// // GD32F130: GPIO_AF_0 = USART, GPIO_AF_1 = I2C
	pinModeAF(USART0_RX, AF_USART0_RX, GPIO_PUPD_PULLUP);	
